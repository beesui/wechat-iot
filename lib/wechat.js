      ...
      if (method === 'GET') {
        ...
        load(req, function (err, buf) {
          ...
          if (messageObj) {
            var messageXml = {
              ToUserName: '',
              FromUserName: messageObj.open_id,
              CreateTime: messageObj.create_time,
              MsgType: 'device_event',
              Event: messageObj.msg_type,
              DeviceType: messageObj.device_type,
              DeviceID: messageObj.device_id,
              Content: messageObj.content,
              MsgId: messageObj.msg_id,
              OpenID: messageObj.open_id,
            };
            req.weixin_obj = messageObj;
            req.weixin = messageXml;
            _respond(req, res, next);
          }
        });
